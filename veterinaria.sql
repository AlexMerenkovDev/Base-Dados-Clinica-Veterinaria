...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 17, 2022 at 09:47 PM
...
INSERT INTO `animal` (`idAnimal`, `nome`, `genero`, `especie`, `cor`, `idade`, `idDono`) VALUES
...
INSERT INTO `tratamento` (`idTratamento`, `designacao`, `custo`, `data`, `tratamento`) VALUES
(1, 'Tomar banho Sempre', 7245.00, '2021-12-02', 'lavar e vacinacao'),
(2, 'foram aplicadas todas as vacinas necessarias', 2500.00, '2022-01-02', 'vacinacao');
